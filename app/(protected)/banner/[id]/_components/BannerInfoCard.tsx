...
export default function BannerInfoCard({ banner }: BannerInfoCardProps) {
  ...
  const handleSave = () => {
    console.log("Saving banner info:", formData);
    closeModal();
  };
        ...
        <div className="no-scrollbar relative border w-full lg:w-[650px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-8">
          <div className="px-2 pr-14">
            ...
            <p className="mb-6 text-sm text-gray-500 dark:text-gray-400">
              Update banner details to keep information current.
            </p>
          </div>
          <form
