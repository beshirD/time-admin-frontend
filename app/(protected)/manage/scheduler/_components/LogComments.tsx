...
const mockComments: Comment[] = [
  {
    id: 1,
    author: "System Admin",
    text: "Log entry created successfully. Monitoring execution status.",
    timestamp: "Feb 14, 2026",
  },
  {
    id: 2,
    author: "Tech Lead",
    text: "Scheduled for execution. Will verify results after completion.",
