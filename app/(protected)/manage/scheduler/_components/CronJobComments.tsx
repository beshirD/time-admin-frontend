...
const mockComments: Comment[] = [
  {
    id: 1,
    author: "John Admin",
    text: "This cron job is running smoothly. No issues detected.",
    timestamp: "Feb 14, 2026",
  },
  {
    id: 2,
    author: "Sarah Manager",
    text: "Great! Let's keep monitoring the logs.",
    timestamp: "1 hour ago",
  },
];

export default function CronJobComments() {
