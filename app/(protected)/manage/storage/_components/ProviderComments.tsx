...
const mockComments: Comment[] = [
  {
    id: 1,
    author: "John Doe",
    text: "This provider is working great for our production environment.",
    timestamp: "Feb 14, 2026",
  },
  {
    id: 2,
    author: "Jane Smith",
    text: "Updated the endpoint configuration successfully.",
    timestamp: "1 hour ago",
  },
];

export default function ProviderComments() {
    ...
    <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6 bg-white dark:bg-gray-800">
      ...
      <form
        ...
        <div className="relative flex items-end gap-2 p-2 border border-gray-300 dark:border-gray-600 rounded-2xl bg-white dark:bg-gray-900 focus-within:border-primary dark:focus-within:border-primary transition-colors">
          ...
          {/* File Upload Button */}
          <label
            htmlFor="provider-comment-file"
            className="shrink-0 p-2 text-gray-500 dark:text-gray-400 hover:text-primary dark:hover:text-primary cursor-pointer transition-colors">
            <Paperclip className="w-5 h-5" />
            <input
              id="provider-comment-file"
              type="file"
              accept="image/*"
          ...
          <button
            ...
            className="shrink-0 p-2 text-white bg-primary hover:bg-primary/90 disabled:bg-gray-300 dark:disabled:bg-gray-700 disabled:cursor-not-allowed rounded-full transition-colors">
